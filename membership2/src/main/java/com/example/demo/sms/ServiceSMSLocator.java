...
public class ServiceSMSLocator extends org.apache.axis.client.Service implements com.example.demo.sms.ServiceSMS {
    ...
    public com.example.demo.sms.ServiceSMSSoap getServiceSMSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.demo.sms.ServiceSMSSoapStub _stub = new com.example.demo.sms.ServiceSMSSoapStub(portAddress, this);
    ...
    public com.example.demo.sms.ServiceSMSSoap getServiceSMSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.demo.sms.ServiceSMSSoap12Stub _stub = new com.example.demo.sms.ServiceSMSSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.demo.sms.ServiceSMSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.demo.sms.ServiceSMSSoapStub _stub = new com.example.demo.sms.ServiceSMSSoapStub(new java.net.URL(ServiceSMSSoap_address), this);
                _stub.setPortName(getServiceSMSSoapWSDDServiceName());
                return _stub;
            }
            if (com.example.demo.sms.ServiceSMSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.demo.sms.ServiceSMSSoap12Stub _stub = new com.example.demo.sms.ServiceSMSSoap12Stub(new java.net.URL(ServiceSMSSoap12_address), this);
                _stub.setPortName(getServiceSMSSoap12WSDDServiceName());
                return _stub;
            }
        }
