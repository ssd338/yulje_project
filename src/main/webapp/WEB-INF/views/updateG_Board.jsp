...
<body>
	...
	<form action="updateG_Board.do" method="post" enctype="multipart/form-data">
		...
		<tr>
			<td>글제목 :</td>
			<td><input type="text" name="title" class="board_input" required="required" value="${gb.title }"></td>
			<td>진료과 :</td>
			<td>
		...
		<tr>
			<td>작성자 :</td>
			<td><input type="text" name="writer" class="board_input_info" value="${gb.writer }" readonly="readonly"></td>
			<td>비밀번호 : </td>
		...
		<tr>
			<td>내용 :</td>
			<td colspan="3"><textarea rows="10" cols="60" name="content">${gb.content }</textarea></td>
		...
		<tr>
			<td>첨부파일 :${gb.fname }</td>
			<td colspan="3">
			<input type="hidden" name="fname" value="${gb.fname }">
