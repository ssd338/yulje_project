...
<body>
	<div class="main_Board">
		<div class="main_input_menu">고마워요 율제병원</div>
		<div class="insert_main">
			...
			<div class="main_input">
				<form action="updateG_Board.do" method="post"
					...
					<div id="main_input_form">
						...
						<table>
							<tr>
								...
								<td><input type="text" name="title" class="board_input"
									required="required" value="${gb.title }"></td>
								<td>진료과 :</td>
								<td><c:if test="${no==0 }">
						...
						${gb.dept_name }
						<input type="hidden" name="dept_name" class="board_input"
											required="required" value="${gb.dept_name }">
									</c:if></td>
							</tr>
							<tr>
								<td>작성자 :</td>
							...
							<tr>
								...
								<td colspan="3"><textarea rows="10" cols="60"
										name="content" value="${gb.content }">${gb.content }</textarea></td>
							...
							<tr>
								<td>첨부파일 :${gb.fname }</td>
								<td colspan="3"><input type="hidden" name="fname"
									value="${gb.fname }"> <input type="file"
									name="uploadFile"></td>
