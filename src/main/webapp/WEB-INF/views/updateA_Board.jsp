			...
			<div class="main_input3">
				<div class="insert_text3">
					...
					<div id="insert_detail3_2">
						<form action="updateA_Board.do" method="post"
								...
								<table>
									<tr>
										...
										<td><input type="text" name="title" class="board_input"
											required="required" value="${ab.title }"></td>
										<td>진료과 </td>
										<td><c:if test="${no==0 }">
												...
												${ab.dept_name }
												<input type="hidden" name="dept_name" class="board_input" required="required" value="${ab.dept_name }">
											</c:if></td>
									</tr>
									<tr>
										<td>작성자 </td>
									...
									<tr>
										...
										<td colspan="3"><textarea rows="10" cols="60"
												name="content" id="textarea2" value="${ab.content }">${ab.content }</textarea></td>
									...
									<tr>
										<td>첨부파일 : ${ab.fname }</td>
										<td colspan="3">
										<input type="hidden" name="fname" value="${ab.fname }">
